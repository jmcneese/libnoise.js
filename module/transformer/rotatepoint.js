...
var RotatePoint = function(sourceModule, xAngle, yAngle, zAngle) {
	...
	this.__defineSetter__('xAngle', function(v) {
	...
	this.__defineSetter__('yAngle', function(v) {
	...
	this.__defineSetter__('zAngle', function(v) {
...
RotatePoint.prototype.setAngles = function(xAngle, yAngle, zAngle) {

	xAngle = parseFloat(xAngle);
	yAngle = parseFloat(yAngle);
	zAngle = parseFloat(zAngle);
...
RotatePoint.prototype.calcMatrices = function() {
...
RotatePoint.prototype.getValue = function(x, y, z) {
